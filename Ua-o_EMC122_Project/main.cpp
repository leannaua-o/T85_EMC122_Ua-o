...
void initRendering() {
	...
	engine->play2D("sounds/music.wav", true);
	...
	Image* image_ground = loadBMP("textures/snow.bmp");
	_textureGround = loadTexture(image_ground);
	delete image_ground;

	Image* image_wall = loadBMP("textures/bricks2.bmp");
	_textureWall = loadTexture(image_wall);
	delete image_wall;

	Image* image_door = loadBMP("textures/door.bmp");
	_textureDoor = loadTexture(image_door);
	delete image_door;

	Image* image_window = loadBMP("textures/window.bmp");
	_textureWindow = loadTexture(image_window);
	delete image_window;
	
	Image* image_roof = loadBMP("textures/roof2.bmp");
	_textureRoof = loadTexture(image_roof);
	delete image_roof;

	Image* image_sky = loadBMP("textures/stars.bmp");
	_textureBall = loadTexture(image_sky);
	delete image_sky;
	ball = gluNewQuadric(); //declared as quadric objects

	Image* image_tree = loadBMP("textures/lights.bmp");
